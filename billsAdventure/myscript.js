const levels = [ 
	...
	// level 3
	["guyleft", "tree","tree","tree","tree","tree","tree","tree",
	"animate","animate","animate","animate","gem","animate","animate","animate",
	...
	"","","","","","","tree","spiderright",
	"","","","","","","tree","animate",
	"gem","boulder","","","","","wallup","animate"],

	// level 5
	["guyleft", "water","water","water","water","water","water","water",
	"animate","animate","","","","","","water",
	"spiderleft","water","water","water","water","water","bridge","water",
	"animate","animate","","","","","","",
	"bridge","water","water","water","water","water","water","water",
	"","","","","","","","boulder",
	"spiderright","","spiderright","","spiderright","","flag","boulder",
	"gem","","","","","","boulder","boulder"],
...
window.addEventListener("load", function (){
	loadLevel();
	showLightBox("Welcome To Bills's adventure!","Your goal is to beat all of the levels by capturing each levels flag. the flag is gaurded by walls which you need a gem to bypass. Also beware of spiders.")
...
function tryToMove(direction) {
	...
	if(nextClass.includes("spider")) {
		showLightBox("GAME OVER", "Click the x to restart.")
		currentLevel = 0;
...
function levelUp(nextClass) {
	if(nextClass == "flag" && isGem && currentLevel != levels.length - 2) {
			
		clearTimeout(currentAnimation);
		setTimeout (function(){
			currentLevel++;
			console.log("the level is " + currentLevel + "max levels is " + levels.length);
			loadLevel();

		}, 1000);
	} else if(nextClass == "flag" && isGem && currentLevel == levels.length - 2){
		...
		showLightBox("GAME OVER", "YOU WON!");
